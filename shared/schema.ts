...
export const users = pgTable("users", {
  ...
  orgFeatureSafeguarding: boolean("org_feature_safeguarding").notNull().default(false),
  orgFeatureSafeguardingExpiresAt: timestamp("org_feature_safeguarding_expires_at"),
  orgFeatureRegister: boolean("org_feature_register").notNull().default(false),
  orgFeatureRegisterExpiresAt: timestamp("org_feature_register_expires_at"),
  orgFeatureAssurance: boolean("org_feature_assurance").notNull().default(false),
...
export const orgFeatureDefaultsSchema = z.object({
  ...
  orgFeatureSafeguarding: z.boolean().optional(),
  orgFeatureSafeguardingExpiresAt: z.string().nullable().optional(),
  orgFeatureRegister: z.boolean().optional(),
  orgFeatureRegisterExpiresAt: z.string().nullable().optional(),
  orgFeatureAssurance: z.boolean().optional(),
  ...
  orgFeatureLoneWorker: z.boolean().optional(),
  orgFeatureLoneWorkerExpiresAt: z.string().nullable().optional(),
});
