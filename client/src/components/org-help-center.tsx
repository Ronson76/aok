...
const HELP_CATEGORIES = [
  ...
  { id: "frontline", label: "Frontline Support", icon: HelpCircle, color: "text-pink-600" },
];
...
const HELP_TOPICS: HelpTopic[] = [
  {
    ...
    content: [
      ...
      "You can add **emergency notes** -  important safety information (e.g. medical conditions, allergies, mobility issues) that will be included in any emergency alerts sent to contacts.",
    ...
    relatedTopics: ["bundles-seats", "client-archive", "client-emergency-notes", "send-ref-reminder"],
  },
  {
    id: "alerts-emergency",
    title: "Alerts -  how emergency notifications work",
    category: "clients",
    keywords: ["alert", "notification", "emergency", "sms", "email", "call", "voice", "notify", "missed", "primary", "non-primary"],
    content: [
      "When a client misses a check-in or triggers an emergency, aok sends alerts to their emergency contacts. Who is notified depends on the alert type and whether a contact is designated as primary.",
      "**Primary contacts/carers (up to 2 on Basic, up to 5 on Essential/Complete):**",
      "Successful check-in -  email only.",
      "Missed check-in -  Basic plan: email only. Essential/Complete plans: email and SMS. No voice call on any plan.",
      "Emergency SOS -  email, SMS, and automated voice call on all plans.",
      "**Non-primary contacts:**",
      "Successful check-in -  not notified.",
      "Missed check-in -  not notified.",
      "Emergency SOS -  email, SMS, and automated voice call.",
      ...
      "Note: Individual users on the Basic plan (£2.99/month) receive email-only alerts for check-ins. Essential (£9.99/month) and Complete (£16.99/month) plans include all alert channels for check-ins.",
  ...
  },
  {
    ...
    relatedTopics: ["audit-trail-overview", "audit-integrity", "audit-expiration-warnings", "gdpr-compliance"],
  },
  {
    id: "audit-expiration-warnings",
    title: "Audit trail -  expiration warnings",
    category: "account",
    keywords: ["audit", "expiration", "warning", "banner", "notification", "alert", "data", "retention", "expire", "countdown"],
    content: [
      "aok automatically monitors your audit trail data and warns you when records are approaching their retention limit.",
      "A **yellow warning banner** appears on the Activity Log when your oldest audit records will expire within **6 months**.",
      "A **red warning banner** appears if records have already passed their expiration date and are due for cleanup.",
      "The banner shows how many days or months remain before your oldest records are removed.",
      "We recommend exporting important audit data (CSV or PDF) before it reaches the expiration date.",
      "You can adjust the retention period at any time from the **Retention Policy** button to extend or shorten the timeframe.",
    ],
    relatedTopics: ["audit-retention", "audit-exports", "audit-trail-overview"],
  },
  {
    id: "client-emergency-notes",
    title: "Client emergency notes",
    category: "clients",
    keywords: ["emergency", "notes", "medical", "allergy", "condition", "safety", "information", "alert", "important"],
    content: [
      "Emergency notes allow you to record important safety information about a client that should be included in any emergency alerts.",
      "Examples include medical conditions, allergies, mobility issues, medication requirements, or any other critical details that emergency contacts should know.",
      "Add emergency notes when registering a new client using the **Emergency Notes** field on the registration form.",
      "When an emergency alert is triggered for a client with emergency notes, the notes are automatically included in the alert messages sent to contacts.",
      "This ensures emergency contacts have vital safety information immediately available when responding to an alert.",
    ],
    relatedTopics: ["add-client", "alerts-emergency"],
  },
  {
    id: "audit-exports",
  ...
  {
    id: "client-archive",
    title: "Client archiving, restoring and permanent deletion",
    category: "clients",
    keywords: ["archive", "remove", "delete", "restore", "soft delete", "archived", "unarchive", "permanent", "permanently"],
    content: [
      ...
      "**Permanent deletion** is available for archived clients and can only be performed by **senior team members** (owners and managers).",
      "To permanently delete an archived client, click the **Delete** button next to the archived client. A confirmation dialog will ask you to confirm -  once confirmed, the client record is removed permanently and cannot be recovered.",
      "This action is logged in the audit trail for accountability.",
    ],
    relatedTopics: ["add-client", "bundles-seats"],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "Contact types:",
      "**Mobile** -  receives alerts via email and SMS. Voice calls are made during Emergency SOS only.",
      "**Landline** -  receives alerts via email and automated voice call during emergencies.",
      "Clients can designate **primary contacts/carers** (up to 2 on Basic, up to 5 on Essential/Complete plans) who receive missed check-in alerts. Non-primary contacts are only alerted during Emergency SOS.",
  ...
  },
  {
    ...
    content: [
      "aok is built with UK GDPR compliance at its core:",
      "**Contact consent** -  emergency contacts must actively confirm before receiving any alerts. The confirmation email includes a privacy notice explaining what data is stored and how to request its removal.",
  ...
  },
  {
    ...
    content: [
      ...
      "Once registered, staff members can start lone worker shifts and their safety is monitored through the organisation dashboard.",
  ...
  },
  {
    ...
    keywords: ["supervisor", "edit", "sms", "verify", "verification", "phone", "primary contact/carer", "details", "name", "email", "update"],
    content: [
      ...
      "Supervisors act as the **primary contact/carer** for missed check-ins and emergencies. Emergency contacts are secondary and only receive alerts during emergencies.",
    ...
    relatedTopics: ["invite-staff", "lone-worker-monitor", "call-supervisor", "lone-worker-checkin-alarm", "supervisor-cancel-emergency"],
  },
  {
    id: "supervisor-cancel-emergency",
    title: "Supervisor emergency cancellation",
    category: "lone-worker",
    keywords: ["cancel", "emergency", "supervisor", "cancellation", "password", "pin", "unresponsive", "safe", "spoken", "confirm", "resolve"],
    content: [
      "When a lone worker becomes **unresponsive** or triggers a **panic alert**, their supervisor can cancel the emergency directly from the **Live Monitor**.",
      "To cancel an emergency, the supervisor must:",
      "1. Click the **Cancel Emergency** button on the worker's session card.",
      "2. Tick the checkbox confirming they have **spoken directly** to the lone worker and the worker has confirmed they are safe.",
      "3. Enter the **organisation dashboard password** -  this is the same password used to log into the organisation account.",
      "The organisation password acts as a security measure to prevent unauthorised cancellations.",
      "If the wrong password is entered, the attempt is **logged in the audit trail** as a failed cancellation.",
      "Once successfully cancelled, the session is resolved as **safe** and the full event is recorded in the audit trail -  including who cancelled it and when.",
    ],
    relatedTopics: ["lone-worker-supervisor", "lone-worker-checkin-alarm", "lone-worker-monitor"],
  },
  {
    ...
    content: [
      ...
      "The supervisor is the primary contact/carer for missed check-ins. Emergency contacts are secondary.",
  ...
  },
  {
    ...
    content: [
      ...
      "Check-in, Shake to SOS, Emergency Alert, GPS Location, Push Notifications, Primary Contact/Carer, SMS Backup, Emergency Recording, Mood Tracking, Pet Protection, Important Documents, Wellbeing AI, Fitness Tracking, and Activities Tracker.",
  ...
  {
    id: "safeguarding-policy-hub",
    title: "Safeguarding Policy Hub",
    category: "safeguarding",
    keywords: ["policy", "hub", "designated", "safeguarding", "lead", "dbs", "check", "training", "records", "compliance", "dashboard", "lead", "readiness"],
    content: [
      "**Overview:** The **Policy** tab in the Safeguarding Hub lets you manage designated safeguarding leads, DBS checks, and training records -  with a compliance dashboard showing your overall readiness.",
      "**Designated Safeguarding Leads:**",
      "Add staff responsible for safeguarding oversight from your team.",
      "Set a primary lead -  the main point of contact for safeguarding matters.",
      "Record their name, role, email, and phone number.",
      "Edit or remove leads as needed using the options on each lead card.",
      "**DBS Checks:**",
      "Record Disclosure and Barring Service checks for your team.",
      "Track certificate numbers, issue dates, and expiry dates.",
      "Set the check status: **Pending**, **Valid**, **Expired**, or **Renewal Due**.",
      "Select the DBS type: **Basic**, **Standard**, **Enhanced**, or **Enhanced with Barred List**.",
      "Update records as new checks are completed or renewals are needed.",
      "**Training Records:**",
      "Log safeguarding training for staff members.",
      "Record the course name, training provider, and completion date.",
      "Track the expiry date for time-limited qualifications.",
      "Add certificate references for verification.",
      "Set the training status: **Pending**, **In Progress**, **Completed**, or **Expired**.",
      "**Compliance Dashboard:**",
      "The dashboard displays four summary cards showing your safeguarding readiness:",
      "**Overall Status** -  a traffic light indicator (Green/Amber/Red) showing your compliance level.",
      "**Designated Leads** -  count of primary and secondary leads currently recorded.",
      "**DBS Checks** -  summary of check statuses across your team.",
      "**Training Completion** -  overview of staff training records and expiry dates.",
      "**Traffic Light Guide:**",
      "**Green** -  fully compliant. You have a primary lead, all DBS checks are valid, and all staff training is current.",
      "**Amber** -  needs attention. You may have no DBS or training records for some staff, or renewals are due soon.",
      "**Red** -  action required. You have no primary lead, or DBS checks/training records have expired.",
    ],
    relatedTopics: ["safeguarding-cases", "safeguarding-incidents", "welfare-concerns", "enterprise-rbac", "assurance-dashboard"],
  },
  {
    id: "enterprise-rbac",
    title: "Enterprise Role-Based Access Control",
    category: "safeguarding",
    keywords: ["rbac", "roles", "permissions", "admin", "safeguarding lead", "service manager", "trustee", "board", "viewer", "access", "enterprise"],
    content: [
      "**Overview:** aok provides enterprise-grade role-based access control (RBAC) to ensure every team member has exactly the right level of access to your organisation's data.",
      "**Roles available:**",
      "**Organisation Admin** -  full access to manage all team members, clients, and settings.",
      "**Safeguarding Lead** -  access to all alerts, safeguarding records, incidents, audit trails, reports, and the assurance dashboard.",
      "**Service Manager** -  manage clients and lone workers within their service area, with access to alerts and analytics.",
      "**Manager** -  manage clients and lone workers, view incidents and reports.",
      "**Staff** -  view assigned clients and alerts only.",
      "**Trustee / Board Member** -  read-only access to the assurance dashboard, reports, analytics, and audit trails for governance oversight.",
      "**Read-Only Viewer** -  limited access to assurance, reports, and analytics only.",
      "**How to assign roles:** Go to Team Management, click the actions menu on any team member, and select their new role. You can also assign roles when inviting new team members.",
      "All role changes are recorded in your tamper-evident audit trail.",
    ],
    relatedTopics: ["team-management", "assurance-dashboard"],
  },
  {
    id: "assurance-dashboard",
    title: "Assurance Dashboard",
    category: "safeguarding",
    keywords: ["assurance", "dashboard", "inspection", "governance", "board", "report", "kpi", "control", "sla", "heatmap", "timeline", "export", "enterprise"],
    content: [
      "**Overview:** The Assurance Dashboard provides a live view of your safeguarding position -  designed for inspections, board governance, and funder due diligence.",
      "This is an enterprise add-on included in selected organisation packages. If you don't see the Assurance button on your dashboard, contact help@aok.care to discuss adding it to your plan.",
      "Access it from the **Assurance** button on your organisation dashboard.",
      "**Live Safeguarding Position** -  KPI tiles showing control effectiveness, SLA compliance, open high-risk alerts, active clients, check-in activity, average response time, and audit chain integrity.",
      "**Service Risk Heatmap** -  see which clients are at high, medium, or low risk based on check-in activity and active alerts.",
      "**Alert Drill-Down** -  view the full escalation chronology for any incident: activation, escalation, response, and outcome.",
      "**Manager Oversight** -  track which managers are active and flag overdue reviews.",
      "**Incident Timeline** -  90-day timeline of all incidents with response times and resolution status.",
      "**Board Report Export** -  generate JSON or CSV reports for board packs, commissioner reviews, and funding applications. Includes all KPIs, risk summary, and incident data.",
      "All data comes from live operations with tamper-evident audit trails and cryptographic integrity verification.",
    ],
    relatedTopics: ["enterprise-rbac", "safeguarding-policy-hub", "grc-compliance", "funder-ready"],
  },
  {
    id: "grc-compliance",
    title: "GRC -  Governance, Risk & Compliance",
    category: "safeguarding",
    keywords: ["grc", "governance", "risk", "compliance", "rbac", "audit", "gdpr", "iso", "security", "2fa", "totp"],
    content: [
      "aok is built with **GRC (Governance, Risk & Compliance)** principles at its core, helping your organisation meet regulatory requirements and demonstrate due diligence.",
      "**Governance** -  enterprise-grade role-based access control (RBAC) with 8 permission tiers ensures every team member has exactly the right level of access. All role changes are audit-logged.",
      "**Risk** -  the Assurance Dashboard provides real-time risk scoring, service risk heatmaps with RAG status indicators, and early-warning indicators for at-risk clients.",
      "**Compliance** -  tamper-evident audit trails with hash-chain verification, exportable PDF and CSV reports for funders and regulators, full security audit logging with PII redaction, and UK GDPR-compliant data handling and retention policies.",
      "**Two-factor authentication (TOTP)** is available for all account types to meet security requirements.",
      "**ISO 27001-compliant infrastructure** underpins the platform, with circuit breaker resilience and multi-provider notification fallback.",
      "For integration with external GRC platforms, see the **API Access** feature which provides read-only endpoints for compliance summaries, risk heatmaps, and incident timelines.",
    ],
    relatedTopics: ["enterprise-rbac", "assurance-dashboard", "api-access-overview", "funder-ready"],
  },
  {
    id: "funder-ready",
    title: "Funder Ready",
    category: "safeguarding",
    keywords: ["funder", "ready", "commissioner", "regulator", "evidence", "report", "audit", "board", "inspection", "outcomes"],
    content: [
    ...
    relatedTopics: ["assurance-dashboard", "grc-compliance", "enterprise-rbac", "funding-assurance", "ecologi-net-zero"],
  },
  {
    id: "funding-assurance",
    title: "Funding Assurance",
    category: "safeguarding",
    keywords: ["funding", "assurance", "finance", "transaction", "allocation", "source", "funder", "grant", "income", "audit", "risk", "compliance", "bank", "import", "activity", "incident", "GRC", "budget", "spending"],
    content: [
      "**Funding Assurance** is an enterprise add-on that gives your organisation a GRC-grade audit trail for all funding activity -  from income to allocation to delivery and incidents.",
      "Access it from the **Funding** button on your organisation dashboard. It is gated by the Organisation Dashboard enterprise toggle -  your admin must enable it.",
      "**Funding Sources** -  record each funder (local authority, housing benefit, grant, charity, or private) with start/end dates, total value, and whether the funding is restricted.",
      "**Transactions** -  log every incoming and outgoing payment against a funding source. Each transaction shows its allocation status (unallocated, partially allocated, or fully allocated).",
      "**Allocations** -  break a transaction into allocations directed at a property, service user, or service. The system enforces that allocated amounts never exceed the transaction total.",
      "**Activities** -  record welfare visits, home visits, lone worker sessions, check-ins, and other activity types. Link each activity to a funding allocation to demonstrate how funding was spent.",
      ...
      "**Overview dashboard** -  at-a-glance cards for total incoming/outgoing this month, unallocated funds, safeguarding coverage percentage, and open incidents, plus a 6-month trend chart.",
      "**Risk & Compliance** -  automated risk flags for unallocated transactions, orphaned allocations, unlinked activities, low safeguarding coverage, and stale incidents. A compliance score (0-100) summarises your governance posture.",
      "**Audit Export** -  download a CSV of every create, update, and delete action across all funding entities, filtered by date range.",
      "**Simulated bank import** -  test your workflow by simulating a bank feed import before connecting a live integration.",
      "Funding Assurance is part of the Organisation Dashboard enterprise add-on. Contact help@aok.care to enable it.",
    ],
    relatedTopics: ["funder-ready", "assurance-dashboard", "grc-compliance", "audit-trail-overview", "audit-exports"],
  },
  {
    id: "ecologi-net-zero",
  ...
  },
  {
    ...
    content: [
      ...
      "**Tier 1 -  Essential** includes core safety features: Check-in, Shake to SOS, Emergency Alert, GPS Location Sharing, Push Notifications, Primary Contact/Carer Notifications, SMS Check-in Fallback, and Emergency Recording.",
  ...
  },
  {
    ...
    content: [
      ...
      "2. If still no response, primary contacts/carers are alerted via email and SMS (no voice calls for missed check-ins).",
  ...
  },
  {
    ...
    content: [
      ...
      "If a client's device loses internet, aok shows an **emergency overlay** with quick-dial buttons for their primary contact/carer and 999.",
  ...
  },
  {
    ...
    category: "api-access",
    keywords: ["api", "key", "external", "grc", "integration", "assurance", "endpoint", "access", "enterprise"],
    content: [
      "The **API Access** page lets you create and manage API keys that allow external platforms to read your assurance data.",
      "This is an enterprise add-on included in selected organisation packages. If you don't see the API button on your dashboard, contact help@aok.care to discuss adding it to your plan.",
    ...
    relatedTopics: ["api-create-key", "api-permissions", "api-endpoints", "grc-compliance"],
  },
  {
    id: "api-create-key",
  ...
  {
    id: "frontline-overview",
    title: "Frontline Support -  overview",
    category: "frontline",
    keywords: ["frontline", "support", "vulnerable", "residents", "housing", "care", "outreach", "interaction", "logging"],
    content: [
      ...
      "It provides structured interaction logging, support signals, engagement tracking, and safeguarding evidence.",
      "Access Frontline Support from the **Frontline** button on your organisation dashboard.",
      "**Key features:**",
      "• **Support Signal** -  residents tap to request help (urgent or routine), with automatic escalation.",
      "• **Quick Log** -  staff log interactions with type, mood, notes, and follow-up actions.",
      "• **Unified Timeline** -  all interactions, signals, check-ins, and safeguarding events in one chronological view per resident.",
      "• **Engagement RAG** -  automatic traffic-light status showing contact recency.",
      "• **Manager View** -  overview of all residents, staff activity, and outstanding follow-ups.",
      "• **Evidence Reports** -  exportable reports for funders, regulators, and board presentations.",
    ],
    relatedTopics: ["frontline-support-signal", "frontline-quick-log", "frontline-timeline", "frontline-engagement-rag"],
  },
  {
    id: "frontline-support-signal",
    title: "Support signals -  how they work",
    category: "frontline",
    keywords: ["support", "signal", "urgent", "routine", "escalation", "resident", "request", "help"],
    content: [
      "Support signals let residents request help with a single tap -  no phone call or complex form needed.",
      "Residents can send two types of signal:",
      "• **Urgent** -  staff are alerted immediately. If no response within 2 minutes, a first escalation is sent. At 5 minutes, a second escalation follows.",
      "• **Routine** -  logged and escalated at 5 minutes (first) and 10 minutes (second) if unacknowledged.",
      "Staff receive email and SMS notifications for incoming signals.",
      "Signals appear on the Frontline dashboard and in the resident's timeline.",
      "Once a staff member responds, they can acknowledge the signal and log an interaction against it.",
    ],
    relatedTopics: ["frontline-overview", "frontline-quick-log"],
  },
  {
    id: "frontline-quick-log",
    title: "Quick Log -  recording interactions",
    category: "frontline",
    keywords: ["quick", "log", "interaction", "record", "welfare", "check", "medication", "emotional", "mood", "notes", "follow-up"],
    content: [
      "Quick Log lets staff record interactions with residents in a structured format.",
      "Select the **interaction type**: welfare check, medication support, emotional support, general check-in, or other.",
      "Record the resident's **mood**: happy, neutral, anxious, upset, or distressed.",
      "Add free-text **notes** about the interaction.",
      "Set a **follow-up action** if needed -  the system will flag outstanding follow-ups on the manager dashboard.",
      "Each log entry is timestamped and attributed to the staff member who created it.",
      "All logged interactions appear in the resident's unified timeline.",
    ],
    relatedTopics: ["frontline-overview", "frontline-timeline"],
  },
  {
    id: "frontline-timeline",
    title: "Unified timeline -  resident history",
    category: "frontline",
    keywords: ["timeline", "history", "chronological", "interactions", "signals", "check-ins", "safeguarding", "events"],
    content: [
      "The unified timeline shows every event related to a resident in chronological order.",
      "Events include: interactions logged by staff, support signals sent by the resident, check-ins, safeguarding incidents, and welfare concerns.",
      "Each event shows the type, timestamp, staff member involved, and relevant details.",
      "Use the timeline to build a complete picture of a resident's engagement and support history.",
      "Timeline data feeds directly into the evidence reports used for funder and regulatory reporting.",
    ],
    relatedTopics: ["frontline-quick-log", "frontline-support-signal", "frontline-evidence-reports"],
  },
  {
    id: "frontline-engagement-rag",
    title: "Engagement RAG status",
    category: "frontline",
    keywords: ["rag", "red", "amber", "green", "engagement", "contact", "recency", "overdue", "safeguarding"],
    content: [
      "Every resident has an automatic RAG (Red, Amber, Green) engagement status based on their last recorded contact.",
      "**Green** -  last interaction within 3 days. Resident is well-engaged.",
      "**Amber** -  last interaction 4-7 days ago. Engagement is declining and may need attention.",
      "**Red** -  no interaction for 7+ days, OR there is an open safeguarding concern. Immediate attention needed.",
      "RAG status is calculated automatically and updates in real time on the Frontline dashboard.",
      "Managers can filter residents by RAG status to prioritise outreach to those most in need.",
    ],
    relatedTopics: ["frontline-overview", "frontline-quick-log"],
  },
  {
    id: "frontline-evidence-reports",
    title: "Evidence reports for funders and regulators",
    category: "frontline",
    keywords: ["evidence", "report", "funder", "regulator", "board", "export", "compliance", "outcomes"],
    content: [
      "Frontline Support generates evidence reports from your interaction data -  ready for funders, commissioners, and regulatory bodies.",
      "Reports show interaction frequency, engagement patterns, signal response times, and safeguarding outcomes.",
      "Export reports as PDF or CSV from the Frontline dashboard.",
      "Reports include tamper-evident audit trail verification, demonstrating data integrity.",
      "Use these reports in board packs, funding applications, CQC inspections, and commissioner reviews.",
    ],
    relatedTopics: ["frontline-overview", "frontline-timeline"],
  },
  {
    id: "kiosk-mode-setup",
    title: "Kiosk mode -  setup and usage",
    category: "clients",
    keywords: ["kiosk", "tablet", "check-in", "station", "shared", "device", "reception", "day centre"],
    content: [
      "Kiosk mode turns a shared tablet into a simple check-in station for residents or clients.",
      "Access kiosk mode from the **Kiosk** button on your organisation dashboard.",
      "Residents see a list of names and tap theirs to check in -  no password needed.",
      "The screen auto-resets after each check-in, ready for the next person.",
      "All kiosk check-ins are fully logged in the audit trail with timestamps.",
      "Ideal for supported living, day centres, sheltered accommodation, and reception areas.",
    ],
    relatedTopics: ["add-client", "client-schedule"],
  },
  {
    id: "operations-resilience",
    title: "Operations and resilience",
    category: "account",
    keywords: ["resilience", "business continuity", "downtime", "fallback", "training", "data quality", "operations"],
    content: [
      "The **Operations & Resilience** page documents how aok handles system disruptions and maintains service continuity.",
      "Access it from the **Resilience** button on your organisation dashboard.",
      "**Business Continuity** -  three severity levels of downtime protocols with defined response procedures.",
      ...
      "**Staff Training Framework** -  seven role-based modules across three pathways, ensuring staff are prepared.",
      "**Data Quality Assurance** -  eight built-in measures including tamper-evident audit trails, RBAC, and regulatory alignment.",
      "This page is designed for board and funder presentations -  print-friendly formatting is included.",
    ],
    relatedTopics: ["audit-trail-overview", "safeguarding-compliance"],
  },
  {
    id: "native-app-features",
    title: "Native Android app features",
    category: "account",
    keywords: ["android", "app", "native", "mobile", "push", "notifications", "firebase", "shake", "haptic"],
    content: [
      "aok is available as a native Android app with the full interface bundled inside.",
      "**Push notifications** -  powered by Firebase Cloud Messaging, receive alerts even when the app is closed.",
      "**Shake to SOS** -  shake your phone to trigger an emergency alert without needing to find the button.",
      "**Haptic feedback** -  vibration responses on check-ins and interactions.",
      "**Native GPS** -  accurate location sharing during emergencies and activity tracking.",
      "The app connects securely to aok.care over HTTPS for all data synchronisation.",
      "Distribute the app to your clients and staff via the Play Store or as a direct APK download.",
    ],
    relatedTopics: ["alerts-emergency", "panic-alerts"],
  },
];
