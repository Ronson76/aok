...
const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "**Client actions** — adding, editing, pausing, resuming, archiving, and restoring clients.",
      "**Staff actions** — invitations sent, accepted, revoked, and deleted.",
      ...
      "**Admin actions** — role changes, bundle assignments, feature toggles.",
  ...
  },
  {
    ...
    content: [
      ...
      "**Fitness Tracking** — record runs, walks, and rides with GPS tracking, route maps, and social features.",
  ...
  },
  {
    ...
    content: [
      "Check-ins are the core safety mechanism in aok.",
  ...
  },
  {
    ...
    content: [
      ...
      "The concern is added to the client's safeguarding case file for ongoing monitoring.",
    ],
