...
const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "3. Enter the staff member's **cancellation password** — this is a separate password the worker set when they created their account.",
      "The cancellation password acts as a security measure to prevent unauthorised cancellations. Only the staff member knows this password and must share it verbally with their supervisor during the call.",
