...
const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Clients can designate up to 3 **primary contacts** who receive missed check-in alerts (email and SMS). Non-primary contacts are only alerted during Emergency SOS.",
  ...
  },
  {
    ...
    content: [
      ...
      "2. If still no response, primary contacts are alerted via email and SMS (no voice calls for missed check-ins).",
