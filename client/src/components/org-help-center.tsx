...
const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "**Primary contacts/carers (up to 3):**",
      "Successful check-in — email only.",
      "Missed check-in — email and SMS. No voice call.",
  ...
  },
  {
    ...
    content: [
      ...
      "Clients can designate up to 3 **primary contacts/carers** who receive missed check-in alerts (email and SMS). Non-primary contacts are only alerted during Emergency SOS.",
