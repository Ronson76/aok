...
const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    category: "account",
    keywords: ["audit", "trail", "log", "record", "compliance", "gdpr", "history", "actions", "activity log", "filter", "search"],
    content: [
