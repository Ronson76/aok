...
const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    category: "safeguarding",
    keywords: ["assurance", "dashboard", "inspection", "governance", "board", "report", "kpi", "control", "sla", "heatmap", "timeline", "export"],
    content: [
    ...
    relatedTopics: ["enterprise-rbac", "safeguarding-policy-hub"],
  },
  {
