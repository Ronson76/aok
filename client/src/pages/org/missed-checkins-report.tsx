...
export default function OrgMissedCheckInsReport() {
  ...
  const { data: missedCheckIns, isLoading } = useQuery<MissedCheckIn[]>({
    queryKey: ["/api/org/missed-checkins"],
  });
  ...
  const downloadPDF = () => {
    ...
    doc.text("Missed Check-ins Report", pageWidth - 14, 18, { align: "right" });
    doc.setFontSize(10);
    ...
    autoTable(doc, {
      startY: 45,
      head: [["Date/Time", "Client Name", "Reference Code"]],
      body: tableData,
    ...
    doc.save(`aok-missed-checkins-${format(new Date(), "yyyy-MM-dd")}.pdf`);
      ...
      <main className="container mx-auto px-4 py-6 space-y-6">
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          ...
          <Button
            ...
            disabled={!filteredMissedCheckIns.length}
        ...
        <Card>
          <CardHeader>
            <CardTitle>All Missed Check-ins ({filteredMissedCheckIns.length})</CardTitle>
          </CardHeader>
          <CardContent>
            {isLoading ? (
              ...
              <div className="space-y-2">
                {filteredMissedCheckIns.map((item) => (
                  <div
                    ...
                    data-testid={`row-missed-checkin-${item.id}`}
                  >
                    <div className="flex items-center gap-4">
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              Download Missed Check-ins Report
            </DialogTitle>
            <DialogDescription>
