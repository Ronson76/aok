...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="funder-ready" className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <Badge variant="outline" className="mb-4 text-sm px-4 py-1">Funder Ready Safeguarding</Badge>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">GRC-Ready Safeguarding Starts With Evidence</h2>
          ...
          <Tabs defaultValue="standards" className="space-y-8">
            ...
            <TabsContent value="standards" className="space-y-8">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold mb-3">Built for the Standards That Matter</h3>
            ...
            <TabsContent value="control" className="space-y-8">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold mb-3">From Written Policy to Live Control Monitoring</h3>
                <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            <TabsContent value="assurance" className="space-y-8">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold mb-3">Continuous Assurance for Your GRC Framework</h3>
                <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            <TabsContent value="funder" className="space-y-8">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold mb-3">Funder-Ready Safeguarding</h3>
                <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            <TabsContent value="levels" className="space-y-8">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold mb-3">Assurance at Every Level</h3>
              </div>
