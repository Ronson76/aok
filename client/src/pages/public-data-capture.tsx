              ...
              <Card className="border-primary/30">
                <CardContent className="p-4 space-y-4">
                  <div className="text-center mb-2">
                    ...
                    <p className="text-xs text-muted-foreground">Enter name and date of birth. If they exist in the system, their data will be pulled. If new, you will be asked to register them.</p>
                  </div>
