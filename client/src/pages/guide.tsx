...
const GUIDE_TOPICS: GuideTopic[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Choose your plan: **Basic** (£2.99/month), **Essential** (£9.99/month), or **Complete** (£16.99/month). There is no free trial.",
      "Complete payment -  Apple Pay and Google Pay are supported.",
  ...
  },
  {
    ...
    content: [
      "When you miss a check-in or trigger an emergency, aok sends alerts to your emergency contacts. Who gets notified depends on the alert type, whether they are a primary contact/carer, and your subscription plan.",
      "**Primary contacts/carers** (up to 2 on Basic, up to 5 on Essential/Complete) receive more frequent updates:",
      "Successful check-in -  primary contacts/carers receive an email confirmation. No SMS or voice call.",
      "Missed check-in -  on **Basic** plan, primary contacts/carers receive an **email only**. On **Essential** and **Complete** plans, they receive an email and SMS.",
      "Emergency SOS -  primary contacts/carers receive an email, SMS, and an automated voice call on all plans.",
      "**Non-primary contacts** are only alerted during genuine emergencies:",
      "Successful check-in -  not notified.",
      "Missed check-in -  not notified.",
      "Emergency SOS -  receive an email, SMS, and automated voice call.",
      "This approach reduces notification fatigue while ensuring critical alerts always get through.",
  ...
  },
  {
    ...
    content: [
      ...
      "2. Wait a short while, then alert your primary contacts/carers by email and SMS. Non-primary contacts are not notified for missed check-ins.",
  ...
  },
  {
    ...
    content: [
      ...
      "**Mobile** -  alerts sent via email and SMS. Voice calls are made during emergencies (SOS) only.",
      "**Landline** -  alerts sent via email and automated voice call during emergencies.",
      "You can designate up to **2** contacts as primary contacts/carers on the **Basic** plan, or up to **5** on the **Essential** and **Complete** plans. Primary contacts/carers receive notifications for missed check-ins. Non-primary contacts are only alerted during Emergency SOS.",
    ],
  },
  {
  ...
  {
    id: "contact-primary",
    title: "Contacts -  primary contact/carer",
    content: [
      "You can designate up to **2** contacts as primary contacts/carers on the **Basic** plan, or up to **5** on the **Essential** and **Complete** plans.",
      "Primary contacts/carers receive an email every time you successfully check in -  so they always know you're safe.",
      "They also receive alerts when you miss a check-in. On the **Basic** plan, missed check-in alerts are **email only**. On **Essential** and **Complete** plans, they receive email and SMS.",
      "Non-primary contacts are only notified during an Emergency SOS -  they receive an email, SMS, and automated voice call.",
    ],
  },
  {
    id: "dark-mode",
  ...
  },
  {
    ...
    content: [
      "Important documents is available on the **Complete** plan only.",
  ...
  },
  {
    ...
    content: [
      "Emergency recording is an opt-in feature available on the **Complete** plan only. It activates your phone's camera and microphone when an emergency alert is triggered.",
  ...
  },
  {
    ...
    content: [
      "aok offers three subscription plans for individual users. There is no free trial -  you choose and pay from the start.",
      "**Basic** (£2.99/month) -  core check-ins and emergency alerts with up to 2 contacts. Missed check-in alerts are email only. SOS alerts always use all channels (email, SMS, voice call).",
      "**Essential** (£9.99/month) -  up to 5 contacts, all alert channels for check-ins and emergencies, Shake to SOS, GPS tracking, push notifications, and offline SMS check-in fallback.",
      "**Complete** (£16.99/month) -  everything in Essential plus mood tracking, pet protection, important documents, wellbeing AI chat, GPS fitness tracking, activities tracker, emergency recording, and voice chat.",
      "You can upgrade your plan at any time from **Settings** in the app.",
  ...
  },
  {
    ...
    title: "Mood tracking",
    content: [
      "Mood tracking is available on the **Complete** plan only.",
  ...
  },
  {
    ...
    content: [
      ...
      "The overlay shows quick-dial buttons for your **primary contact/carer** and **999**.",
  ...
  },
  {
    ...
    content: [
      "Pet protection is available on the **Complete** plan only.",
  ...
  },
  {
    ...
    content: [
      "Fitness tracking is available on the **Complete** plan only.",
  ...
  },
  {
    ...
    content: [
      "The Activities tracker is available on the **Complete** plan only.",
      ...
      "While active, you can quickly **call your primary contact/carer** or **call 999** from the session screen.",
      ...
      "**Low battery alert**: If your phone battery drops below 20% during an active activity, your primary contacts/carers are automatically emailed a warning. This only happens once per session, and only during activities -  not at any other time. A visual warning also appears on your screen.",
  ...
  },
  {
    ...
    content: [
      "aok offers three individual subscription plans with no free trial:",
      "**Basic** -  £2.99/month. Core check-ins and emergency alerts with up to 2 contacts. Missed check-in alerts are email only. SOS alerts use all channels.",
      "**Essential** -  £9.99/month. Up to 5 contacts, all alert channels, Shake to SOS, GPS tracking, push notifications, and offline SMS check-in fallback.",
      "**Complete** -  £16.99/month or £169.99/year (save 2 months). Everything in Essential plus mood tracking, pet protection, important documents, wellbeing AI chat, voice chat, GPS fitness tracking, activities tracker, emergency recording, and a tree planted via Ecologi.",
  ...
  },
  {
    ...
    content: [
      "aok is built with your privacy in mind and complies with **UK GDPR**:",
      "**Emergency contacts** must confirm consent before receiving any alerts. Their confirmation email includes a privacy notice explaining what data is stored and how to request removal.",
      ...
      "- **Export**: Download all your data in a portable JSON format from **Settings > Your Data & Privacy > Export**",
  ...
  },
  {
    ...
    content: [
      ...
      "6. Choose your plan -  **Basic** (£2.99/month), **Essential** (£9.99/month), or **Complete** (£16.99/month) -  and complete payment.",
  ...
  },
  {
    ...
    title: "Safeguarding Policy Hub (organisations)",
    content: [
      "The **Safeguarding Policy Hub** is a centralised location for managing your organisation's safeguarding compliance and staff records.",
      "Navigate to **Safeguarding Hub > Policy** tab to access all safeguarding management features.",
      "**Designated Safeguarding Leads** section allows you to manage staff responsible for safeguarding:",
      "Add staff members and designate a primary safeguarding lead.",
      "Record each lead's name, role, email address, and phone number for easy contact.",
      "Ensure you always have a primary lead assigned for compliance.",
      "**DBS Checks** section tracks Disclosure and Barring Service checks for your staff:",
      "Record certificate numbers, issue dates, and expiry dates for each check.",
      "Track the status of each check: **Pending** (awaiting results), **Valid** (in date and compliant), **Expired** (requires renewal), or **Renewal Due** (approaching expiry).",
      "Supports all DBS check types: **Basic**, **Standard**, **Enhanced**, and **Enhanced with Barred List**.",
      "**Training Records** section allows you to track safeguarding training completion:",
      "Record the course name, training provider, completion date, and expiry date.",
      "Add certificate references for audit trail purposes.",
      "Track status for each training record: **Pending** (not yet started), **In Progress** (currently training), **Completed** (fully compliant), or **Expired** (requires renewal).",
      "**Compliance Dashboard** provides an at-a-glance view of your organisation's safeguarding status:",
      "Traffic light system shows overall compliance: **Green** (fully compliant), **Amber** (needs attention), or **Red** (action required).",
      "See the status of designated leads, DBS checks, and training records all in one place.",
      "Use this dashboard to identify gaps and ensure your organisation meets all safeguarding requirements.",
    ],
  },
  {
    id: "enterprise-rbac",
    title: "Enterprise Role-Based Access Control (organisations)",
    content: [
      "aok supports **enterprise-grade role-based access control (RBAC)** for organisations, ensuring every team member has exactly the right level of access.",
      "Navigate to **Team Management** from your organisation dashboard to manage members and roles.",
      "**Available roles:**",
      "**Organisation Owner** -  full access to everything, including billing and settings.",
      "**Organisation Admin** -  full access to manage all team members, clients, and organisation settings.",
      "**Safeguarding Lead** -  access to all alerts, safeguarding records, incidents, audit trails, reports, and assurance dashboard. Ideal for designated safeguarding officers.",
      "**Service Manager** -  manage clients and lone workers for their service area. View alerts, safeguarding records, and analytics.",
      "**Manager** -  manage clients and lone workers, view incidents and reports.",
      "**Staff** -  view assigned clients and alerts. Cannot manage settings or other team members.",
      "**Trustee / Board Member** -  read-only access to assurance dashboard, reports, analytics, and audit trails. Perfect for governance oversight.",
      "**Read-Only Viewer** -  limited read-only access to assurance dashboard, reports, and analytics.",
      "Each role automatically inherits specific permissions. Owners and admins can change roles, invite new members, disable accounts, and remove team members.",
      "All role changes are recorded in the tamper-evident audit trail for compliance and governance purposes.",
    ],
  },
  {
    ...
    content: [
      ...
      "**Screen 3: Alert Drill-Down** -  select any incident to view the full chronology: time of activation, escalation steps, response actions, and final outcome. This is your safeguarding effectiveness evidence.",
      "**Screen 4: Manager Oversight** -  shows which managers and leads are active, when they last logged in, and flags overdue reviews. This answers the inspection question: 'How do leaders monitor practice?'",
      "**Screen 5: Incident Timeline** -  a 90-day timeline of all incidents with activation time, resolution status, response time, and location data. This is your serious incident defensibility evidence.",
      "**Screen 6: Board Governance Report** -  export your safeguarding position as a JSON or CSV report for board packs, commissioner reviews, and funder due diligence. Includes all KPIs, risk summary, and incident data.",
      "All data is calculated from live operational data with tamper-evident audit trails and cryptographic integrity verification.",
    ],
  },
  {
    id: "api-access",
  ...
  },
  {
    ...
    content: [
      ...
      "This feature is available on the **Essential** and **Complete** plans. It is not available on the Basic plan.",
  ...
  },
  {
    ...
    content: [
      ...
      "If you ever become unresponsive during a shift, your supervisor will call you to verify you're safe before cancelling the emergency from the organisation dashboard.",
  ...
  },
  {
    ...
    content: [
      "aok offers three subscription tiers for individual users:",
      "**Basic** (£2.99/month) -  core check-ins and emergency alerts with up to 2 contacts. Missed check-in alerts are **email only**. SOS alerts always use all channels (email, SMS, voice call). Does not include Shake to SOS, GPS tracking, emergency recording, or any wellbeing features.",
      "**Essential** (£9.99/month) -  up to 5 contacts, all alert channels (email, SMS, voice call) for both check-ins and emergencies, Shake to SOS, GPS tracking, push notifications, and offline SMS check-in fallback. Does not include mood tracking, pet protection, important documents, activities tracker, emergency recording, or wellbeing AI.",
      "**Complete** (£16.99/month) -  everything in Essential plus mood tracking, pet protection, important document storage, wellbeing AI chat, voice chat, GPS fitness tracking, activities tracker, and emergency recording.",
      "There is no free trial. You choose and pay for your plan when you create your account.",
      "If you're managed by an organisation, your access is included at no cost to you and your available features may vary depending on what your organisation has enabled.",
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "You can see your current plan (**Basic**, **Essential**, or **Complete**), whether your subscription is active, or if your plan is set to cancel.",
      "Your next billing date is also displayed.",
      "You can **upgrade** your plan at any time from Settings to unlock more features and higher contact limits.",
  ...
  },
  {
    ...
    content: [
      "Voice chat is available on the **Complete** plan only.",
  ...
  },
  {
    ...
    content: [
      "Wellbeing AI chat is available on the **Complete** plan only.",
  ...
  },
  {
    ...
    content: [
      "You can upgrade your subscription plan at any time from within the app.",
      "Go to **Settings** and find the subscription section.",
      "Tap **Upgrade Plan** to see the available plans and their features.",
      "Choose the plan you'd like to upgrade to and confirm payment.",
      "Your new plan features will be available immediately after upgrading.",
      "Upgrading from **Basic** to **Essential** unlocks more contacts (up to 5), all alert channels, Shake to SOS, GPS tracking, and push notifications.",
      "Upgrading from **Essential** to **Complete** adds mood tracking, pet protection, important documents, wellbeing AI, voice chat, GPS fitness tracking, activities tracker, and emergency recording.",
    ],
  },
  {
    id: "call-primary-contact",
    title: "Call primary contact (quick-dial)",
    content: [
      "Your dashboard includes a quick-dial button to call your primary contact/carer directly.",
      "Tap the **Call Primary Contact** button on your dashboard to place a call.",
      "A confirmation dialog appears before the call is placed, so you won't accidentally call them.",
      "This feature uses your phone's native dialler -  your primary contact's phone will ring like a normal incoming call.",
      "This is useful when you need to speak to someone quickly without navigating to the Contacts page.",
      "You must have at least one confirmed primary contact/carer for this button to appear.",
    ],
  },
  {
    id: "what3words",
