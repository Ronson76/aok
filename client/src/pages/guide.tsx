...
const GUIDE_TOPICS: GuideTopic[] = [
  ...
  },
  {
    ...
    content: [
      "When you miss a check-in or trigger an emergency, aok sends alerts to your emergency contacts. Who gets notified depends on the alert type and whether they are a primary contact/carer.",
      "**Primary contacts/carers (up to 3)** receive more frequent updates:",
      "Successful check-in — primary contacts/carers receive an email confirmation. No SMS or voice call.",
      "Missed check-in — primary contacts/carers receive an email and SMS. No voice call.",
      "Emergency SOS — primary contacts/carers receive an email, SMS, and an automated voice call.",
  ...
  },
  {
    ...
    content: [
      ...
      "You can designate up to 3 contacts as **primary contacts/carers**. Primary contacts/carers receive notifications for missed check-ins (email and SMS). Non-primary contacts are only alerted during Emergency SOS.",
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      "You can designate up to 3 contacts as **primary contacts/carers**.",
      "Primary contacts/carers receive an email every time you successfully check in — so they always know you're safe.",
      "They also receive email and SMS alerts when you miss a check-in.",
  ...
  },
  {
    ...
    content: [
      ...
      "**Tier 1 — Essential** includes core safety features: check-ins, emergency alerts, SMS and voice call alerts, GPS location sharing, push notifications, primary contact/carer notifications, SMS check-in fallback, and Shake to SOS.",
