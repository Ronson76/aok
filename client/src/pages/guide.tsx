...
const GUIDE_TOPICS: GuideTopic[] = [
  ...
  },
  {
    ...
    content: [
      "When you miss a check-in or trigger an emergency, aok sends alerts to your emergency contacts. Who gets notified depends on the alert type and whether they are a primary contact.",
      "**Primary contacts (up to 3)** receive more frequent updates:",
      "Successful check-in — primary contacts receive an email confirmation. No SMS or voice call.",
      "Missed check-in — primary contacts receive an email and SMS. No voice call.",
      "Emergency SOS — primary contacts receive an email, SMS, and an automated voice call.",
  ...
  },
  {
    ...
    content: [
      ...
      "2. Wait a short while, then alert your primary contacts by email and SMS. Non-primary contacts are not notified for missed check-ins.",
  ...
  },
  {
    ...
    content: [
      ...
      "You can designate up to 3 contacts as **primary contacts**. Primary contacts receive notifications for missed check-ins (email and SMS). Non-primary contacts are only alerted during Emergency SOS.",
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      "You can designate up to 3 contacts as **primary contacts**.",
      "Primary contacts receive an email every time you successfully check in — so they always know you're safe.",
